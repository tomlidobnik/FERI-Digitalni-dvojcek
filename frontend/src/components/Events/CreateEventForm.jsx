        ...
        <div className="flex flex-col w-full h-full min-h-fit p-4 xl:p-6 overflow-y-auto">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4 w-full">
                    ...
                    <div className="flex flex-col gap-0.5">
                        ...
                        <input type="text" className="bg-black/10 p-3 text-xl rounded-2xl shadow-md focus:border-tertiary focus:outline-tertiary focus:outline-0 border-black/20 border-4" value="TODO (ne deluje sedaj)"/>
                        <div className="text-error h-2">

...
return (
    <div className="flex flex-col md:flex-row h-full w-full bg-linear-to-t to-primary from-quaternary/35 md:from-quaternary/50 lg:bg-none lg:bg-primary md:rounded-2xl md:shadow-2xl p-2 xl:p-4 min-h-fit">
        ...
        <div className="w-full md:w-1/2 flex flex-col h-full bg-white/40 rounded-2xl shadow-lg p-4 ml-0 md:ml-2 mt-4 md:mt-0 min-h-[400px]">
            {chattingWithFriendId && (
                <FriendChat
            ...
            {!chattingWithFriendId && (
                <div className="flex flex-1 items-center justify-center text-text-custom/60 text-lg">
                    Izberi prijatelja za klepet.
                </div>
            )}
        </div>
    </div>
